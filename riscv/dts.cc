                     ...
                     std::vector<std::pair<reg_t, mem_t*>> mems)
{
  ...
  s << std::hex << ">;\n"
         ...
         "    };\n"
         "    MEMORY_WG_0: memory@" << mems.size() << " {\n"
         "      device_type = \"memory\";\n"
         "      reg = <0x0 0x9000 0x0 0x1000>;\n"
         "    };\n"
         "    MEMORY_WG_1: memory@" << mems.size() + 1 << " {\n"
         "      device_type = \"memory\";\n"
         "      reg = <0x0 0xA000 0x0 0x1000>;\n"
         "    };\n"
         "    MEMORY_WG_2: memory@" << mems.size() + 2 << " {\n"
         "      device_type = \"memory\";\n"
         "      reg = <0x0 0xB000 0x0 0x1000>;\n"
         "    };\n"
         "    MEMORY_WG_3: memory@" << mems.size() + 3 << " {\n"
         "      device_type = \"memory\";\n"
         "      reg = <0x0 0x5000000 0x0 0x1000000>;\n"
         "    };\n"
         "    WG0: wg_filter@0 {\n"
         "      compatible = \"sifive,wgFilter\";\n"
         "      reg = <0x0 0x32000 0x0 0x100>;\n"
         "      reg-names = \"control\";\n"
         "      node = <&MEMORY_WG_0>;\n"
         "    };\n"
         "    WG1: wg_filter@1 {\n"
         "      compatible = \"sifive,wgFilter\";\n"
         "      reg = <0x0 0x32200 0x0 0x100>;\n"
         "      reg-names = \"control\";\n"
         "      node = <&MEMORY_WG_1>;\n"
         "    };\n"
         "    WG2: wg_filter@2 {\n"
         "      compatible = \"sifive,wgFilter\";\n"
         "      reg = <0x0 0x32400 0x0 0x100>;\n"
         "      reg-names = \"control\";\n"
         "      node = <&MEMORY_WG_2>;\n"
         "    };\n"
         "    WG3: wg_pmp@0 {\n"
         "      compatible = \"sifive,wgpmp\";\n"
         "      reg = <0x0 0x33000 0x0 0x100>;\n"
         "      reg-names = \"control\";\n"
         "      node = <&MEMORY_WG_3>;\n"
         "    };\n"
         "    WG4: wg_marker@0 {\n"
         "      compatible = \"sifive,wgMarker\";\n"
         "      reg = <0x0 0x52000 0x0 0x200>;\n"
         "      reg-names = \"control\";\n"
         "      node = <&CPU0>;\n"
         "    };\n"
         "    WG5: tl_wg_marker_hart1@30200 {\n"
         "      compatible = \"sifive,wgMarker\";\n"
         "      reg = <0x0 0x52200 0x0 0x200>;\n"
         "      reg-names = \"control\";\n"
         "      node = <&CPU1>;\n"
         "    };\n"
         "  };\n"
